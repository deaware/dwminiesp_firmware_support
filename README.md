...
![](http://128.199.176.236/dwminiesp_support/images/insert_board_man_url3.png)

* Open **"Boards Manager"** by goto **Tools > Board > Boards Manager...**

![](http://128.199.176.236/dwminiesp_support/images/select_boards_manager3.png)

* Select **ESP8266 by Deaware** then click **Install**.

![](http://128.199.176.236/dwminiesp_support/images/install_esp82663.png)

* Check **ESP8266** is available by goto **Tools > Board** and you will see **Gerneric ESP8266 Module**.

![](http://128.199.176.236/dwminiesp_support/images/dwminiesp_found3.png)

#### 3) Uploading program to DW.miniESP
* Preparing your code.

![](http://128.199.176.236/dwminiesp_support/images/prepare_code3.png)

* Confirm that your setting is correct.

![](http://128.199.176.236/dwminiesp_support/images/set_board3.png)
...
![](http://128.199.176.236/dwminiesp_support/images/switch_prog3.png)

* Press upload button to upload.

![](http://128.199.176.236/dwminiesp_support/images/uploaded3.png)
